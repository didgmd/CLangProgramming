...
- 课件规划：16次讲授课、8次上机课，讲授32学时、上机16学时，共48学时；当前完成度为结构规划24/24、课程引入PPTX 1/16、讲授HTML 16/16。学生端HTML均不超过36页，并已将ASCII、表达式求值、循环控制、字符串标准库函数、函数返回规则、数组名与指针以及文件函数等往届知识点嵌入相应课次。

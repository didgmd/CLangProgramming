 ...
 * 来源：2024-2025-1/20241119_1122/9.12.c
 * 编译模式：c11-strict
 * 旧语法：无
 * 交互方式：manual
                ...
                for (k = red; k <= black; k++) // 內循环使k的值从red变到black
                    if ((k != i) && (k != j))  // 如果3球不同色
                    {
                        ...
                        for (loop = 1; loop <= 3; loop++) // 先后对3个球分别处理
                        {
                            ...
                            case 1:
                                pri = i;
                                break; // loop的值为1时，把第1球的颜色赋给pri
                            case 2:
                                pri = j;
                                break; // loop的值为2时，把第2球的颜色赋给pri
                            case 3:
                                pri = k;
                                break; // loop的值为3时，把第3球的颜色赋给pri
                            default:
                                break;
                            }
                            ...
                            case red:
                                printf("%-10s", "red");
                                break; // pri的值等于枚举常量red时输出"red"
                            case yellow:
                                printf("%-10s", "yellow");
                                break; // pri的值等于枚举常量yellow时输出"yellow"
                            case blue:
                                printf("%-10s", "blue");
                                break; // pri的值等于枚举常量blue时输出"blue"
                            case white:
                                printf("%-10s", "white");
                                break; // pri的值等于枚举常量white时输出"white"
                            case black:
                                printf("%-10s", "black");
                                break; // pri的值等于枚举常量black时输出"black"
                            default:
                                break;
                            }
                        }
